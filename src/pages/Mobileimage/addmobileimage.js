...
const AddMobileimage = () => {
    ...
    const addMobileimage = async (e) => {
        ...
        try {
            ...
            postData("/api/mobileimg/create", formData).then((res) => {
                if (res.error !== true) {
                    context.setAlertBox({
                        open: true,
                        error: false,
                        msg: "The Mobile Image is created!"
                    })
                    setIsLoading(false)
                    history("/mobileimage")
                } else {
        ...
        <>
            <div className="right-content w-100">
                <div className="card shadow border-0 w-100 flex-row p-4 mt-2 res-col">
                    <h5 className="mb-4">Add Mobile Image</h5>
                ...
                <form className="form" onSubmit={addMobileimage}>
