...
const EditHomepageimage = () => {
    ...
    useEffect(() => {
        ...
        fetchDataFromApi(`/api/homepageimg/${id}`).then((res) => {
    ...
    const editHomepageimage = (e) => {
        ...
        try {
            ...
            editData(`/api/homepageimg/${id}`, formData).then((res) => {
                if (res.error !== true) {
                    context.setAlertBox({
                        open: true,
                        error: false,
                        msg: "The Home Page Image is updated!"
                    })
                    setIsLoading(false)
        ...
        <>
            <div className="right-content w-100">
                <div className="card shadow border-0 w-100 flex-row p-4 res-col">
                    <h5 className="mb-4">Edit Home Page Image</h5>
                    <Breadcrumbs aria-label="breadcrumb" className="ml-auto breadcrumbs_">
                        ...
                        />
                        <StyledBreadcrumb
                            label="Edut Home Page Image"
                            deleteIcon={<ExpandMoreIcon />}
                        />
                    </Breadcrumbs>
                </div>

                <form className="form" onSubmit={editHomepageimage}>
...
export default EditHomepageimage;